...
MM_FWD_CLASS( WaterListener )
MM_FWD_CLASS( PhysicsComponent )
MM_FWD_CLASS( CarryManager )
MM_FWD_CLASS( CarryableObject )
MM_FWD_STRUCT( ItemCollection )
MM_FWD_STRUCT( SaveSlot )
MM_FWD_CLASS( PagedMenu )
MM_FWD_CLASS( OptionsMenu )
MM_FWD_CLASS( OptionsMenuControl )
MM_FWD_CLASS( OptionsMenuControlSlider )
MM_FWD_CLASS( Player )
MM_FWD_CLASS( Pickup )
MM_FWD_CLASS( PickupListener )
MM_FWD_CLASS( ShopItem )
MM_FWD_CLASS( Chest )
